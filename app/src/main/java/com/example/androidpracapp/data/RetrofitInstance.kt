...
import com.example.androidpracapp.data.services.OrdersManagementService
...
//        .build()
    ...
    val orderManagementService = retrofit.create(OrderManagementService::class.java)
    val ordersManagementService = retrofit.create(OrdersManagementService::class.java)
}